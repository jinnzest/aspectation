    ...
    [ testCaseParse
      ...
      testCaseParse
        ...
        [sbt|
            ...
            |				with
            |		argument 1argument in brackets 1
            ...
            |				and
            |		argument 2argument in brackets 2
      ...
      testCaseParse
        ...
        [sbt|
            ...
            |],
      testCaseParse
        "(some text) ->  \"beginning \"\"then some text inside\"\" and  \"\"\"\"again\"\"\"\"  and then continuation\" "
        [sbt|
            |1:1 - 1:96 function
            |	function signature
            |		argument 1argument in brackets 1
            |			1:2 - 1:6 alpha numberic word
            |				some
            |			1:7 - 1:11 alpha numberic word
            |				text
            |	1:13 - 1:96 function body
            |		1:17 - 1:96 text
